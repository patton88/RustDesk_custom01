@echo off
echo ========================================
echo RustDesk Debug Fix Test v9 (Final)
echo ========================================
echo.
...
echo 测试19: 终端管理员连接测试
echo 运行: rustdesk.exe --terminal-admin=10.2.10.216 --password="Abcd$1234"
rustdesk.exe --terminal-admin=10.2.10.216 --password="Abcd$1234"
timeout /t 5 /nobreak >nul
taskkill /f /im rustdesk.exe >nul 2>&1
echo.
...
echo 测试22: 终端和终端管理员混合测试
echo 运行: rustdesk.exe --terminal=10.2.10.216 --terminal-admin=10.2.10.217 --password="Abcd$1234"
rustdesk.exe --terminal=10.2.10.216 --terminal-admin=10.2.10.217 --password="Abcd$1234"
timeout /t 5 /nobreak >nul
taskkill /f /im rustdesk.exe >nul 2>&1
echo.
