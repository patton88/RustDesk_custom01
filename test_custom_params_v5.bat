@echo off
echo ========================================
echo RustDesk Custom Parameters Test v5 (Final)
echo ========================================
echo.
...
echo Test 8: Connection with equals format (should work without deadlock)
echo Running: rustdesk.exe --connect=10.2.10.216 --password=Abcd1234
echo Expected: App starts, shows connection dialog, NO DEADLOCK
rustdesk.exe --connect=10.2.10.216 --password=Abcd1234
timeout /t 3 /nobreak >nul
echo.
